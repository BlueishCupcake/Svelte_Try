...
<main>
  <section class="main-section">
    ...
    <span class="text"> trying diferent styles and ideas </span>

    <button class="primary-button"> Like this button for exemple </button>

    <button class="secondary-button"> Or this one </button>

    <img class="ghost" src="ghost.svg" alt="floating ghost" />
    ...
    <div class="wrapper">
      <div class="wrapper__links">
        <a
          ...
          id="github"
          href="https://github.com/BlueishCupcake"
          target="_blank"
